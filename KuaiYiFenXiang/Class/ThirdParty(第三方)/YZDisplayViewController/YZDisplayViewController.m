...
//    UILabel *linelabel=[[UILabel alloc]initWithFrame:CGRectMake((SCREEN_WIDTH-2)/3, 0, 2,_titleScrollView.height-2)];
//    [linelabel setBackgroundColor:BACKVIEWCOLOR];
//    [_titleScrollView addSubview:linelabel];
//    
//    UILabel *linelabel2=[[UILabel alloc]initWithFrame:CGRectMake(((SCREEN_WIDTH-2)/3)*2+5, 0, 2,_titleScrollView.height-2)];
//    [linelabel2 setBackgroundColor:BACKVIEWCOLOR];
//    [_titleScrollView addSubview:linelabel2];
...
- (UIScrollView *)contentScrollView
{
    if (_contentScrollView == nil) {
        ...
        // scrollView需要支持侧滑返回
//        [self tz_addPopGestureToView:_contentScrollView];
