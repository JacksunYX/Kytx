...
typedef void(^PYDidSearchBlock)(PYSearchViewController *searchViewController, UISearchBar *searchBar, NSString *searchText,NSString *searchtypes,NSString * VagueOrSpecific);
...
- (void)searchViewController:(PYSearchViewController *)searchViewController
         searchTextDidChange:(UISearchBar *)searchBar
                  searchText:(NSString *)searchText searchType:(NSString*)searchType;
...
@property (nonatomic, copy) NSString *searchheadviewHidden;
...
+ (instancetype)searchViewControllerWithHotSearches:(NSArray<NSString *> *)hotSearches
                            ...
                            andsearchHeadViewHidden:(NSString *)searchHeadViewHidden;
