...
- (void)setUpUI
{
    ...
    for (NSInteger i = 0; i < titles.count; i++) {
        ...
        [button.titleLabel setFont:PFR15Font];
...
- (void)buttonClick:(UIButton *)button
{
    ...
    if (weakself.searchheadClickBlock) {
        //将自己的值传出去，完成传值
        weakself.searchheadClickBlock(button.titleLabel.text);
    }
