...
-(void)initCapture{
    ...
    btView.center = CGPointMake(SCREEN_WIDTH/2, preLayerHeight*0.8);
    ...
    finishBt.center = CGPointMake(SCREEN_WIDTH-45, preLayerHeight*0.8);
    finishBt.adjustsImageWhenHighlighted = NO;
    [finishBt setBackgroundImage:[UIImage imageNamed:@"payweixuanzhong"] forState:UIControlStateNormal];
...
- (void)onTimer:(NSTimer *)timer
{
    ...
    [progressPreView setFrame:CGRectMake(0, preLayerHeight-70, progressWidth, 4)];
    if (currentTime>2) {
        finishBt.hidden = NO;
    }
...
//                    NSData *data = [NSData dataWithContentsOfFile:path];
//                    
//                    NSLog(@"mergeFileURL---------------%@",mergeFileURL);
//                    
//                    PlayVideoViewController* view = [[PlayVideoViewController alloc]init];
//                    
