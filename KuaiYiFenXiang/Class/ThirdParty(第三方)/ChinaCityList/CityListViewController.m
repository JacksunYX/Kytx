...
- (void)setNavigationWithTitle:(NSString *)title
{
    ...
    [backBtn setImage:[UIImage imageNamed:@"icon_cha"] forState:UIControlStateNormal];
...
- (void)ininHeaderView
{
    ...
    //定位城市 在定位城市添加图片标记
    UIImageView *addressimageview=[[UIImageView alloc]initWithFrame:CGRectMake(15, 10, 15, 20)];
    [addressimageview setImage:[UIImage imageNamed:@"localize"]];
    [_tableHeaderView addSubview:addressimageview];
    
    
    UILabel *title1 = [[UILabel alloc]initWithFrame:CGRectMake(addressimageview.right+10, 10, 160, 21)];
    title1.text = @"定位城市";
...
//    replicatorLayer.bounds          = CGRectMake(0, 0, 60, 20);
//    replicatorLayer.cornerRadius    = 10.0;
//    replicatorLayer.position        =  title1.center;
//    replicatorLayer.backgroundColor = [UIColor clearColor].CGColor;
//    
//    [title1.layer addSublayer:replicatorLayer];
//    
...
//    if ([item.cityItem.titleName isEqualToString:@"武汉"]) {
