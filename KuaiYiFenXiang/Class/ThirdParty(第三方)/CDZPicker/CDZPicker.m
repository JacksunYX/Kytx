...
//    btn.frame = CGRectMake(0, 100, SCREEN_WIDTH, CDZToolBarHeight);
...
- (UIPickerView *)pickerView{
    if (!_pickerView) {
        CGFloat pickerViewHeight = self.builder.pickerHeight > CDZToolBarHeight ? self.builder.pickerHeight : CDZPickerViewDefaultHeight;
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0,0, SCREEN_WIDTH, pickerViewHeight - CDZToolBarHeight)];
