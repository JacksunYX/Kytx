...
@interface ShopUploadTableViewCell ()
...
@implementation ShopUploadTableViewCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        _label1 = [UILabel new];
        _label1.text = @"上传店铺logo：";
...
//        _btn1.layer.masksToBounds = YES;
        ...
        [alabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(_btn1).offset(-7);
        }];
...
//        _btn2.layer.masksToBounds = YES;
        ...
        [blabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(_btn2).offset(-7);
        }];
...
//        _btn3.layer.masksToBounds = YES;
        ...
        [clabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(_btn3).offset(-7);
        }];
