...
#import "UserForgot3ViewController.h"
#import "KYHeader.h"

@interface UserForgot2ViewController ()<UITextFieldDelegate>
...
@implementation UserForgot2ViewController
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (range.location == 5) {
            // 用户
            UserForgot3ViewController *vc = [UserForgot3ViewController new];
