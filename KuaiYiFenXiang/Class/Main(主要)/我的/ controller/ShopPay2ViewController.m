...
#import "ShopPay2ViewController.h"
#import "KYHeader.h"
#import "ShopPay3ViewController.h"

@interface ShopPay2ViewController ()<UITextFieldDelegate>
...
@implementation ShopPay2ViewController
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (range.location == 5) {
            ShopPay3ViewController *vc = [ShopPay3ViewController new];
