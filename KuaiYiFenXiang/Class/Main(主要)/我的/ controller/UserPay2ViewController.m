...
#import "UserPay2ViewController.h"
#import "KYHeader.h"
#import "UserPay3ViewController.h"

@interface UserPay2ViewController ()<UITextFieldDelegate>
...
@implementation UserPay2ViewController
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (range.location == 5) {
        UserPay3ViewController *vc = [UserPay3ViewController new];
        vc.pwd = self.pwd;
        vc.confirm = [self.tf.text stringByAppendingString:string];
