...
- (void)setSubItem:(DCCalssSubItem *)subItem
{
    ...
    NSLog(@"image_url-----%@",[NSString stringWithFormat:@"%@%@",DefaultDomainName,subItem.image_url]);
    
    [_goodsImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",DefaultDomainName,subItem.image_url]] placeholderImage:[UIImage imageNamed:@"applogo"]];
