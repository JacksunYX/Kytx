...
@interface ShoppingCarLatestRecommendedCollectionViewCell ()
...
@implementation ShoppingCarLatestRecommendedCollectionViewCell
...
-(void)setGoodsUnifiedModel:(GoodsUnifiedModel *)GoodsUnifiedModel{
    ...
    [self.addshoppingcarButton setImage:[UIImage imageNamed:@"addshoppingcarimage"] forState:UIControlStateNormal];
...
{
    if (_addshoppingcarButton == nil) {
        _addshoppingcarButton = [[UIButton alloc] init];
    }
    [self.contentView addSubview:_addshoppingcarButton];
    [_addshoppingcarButton addTarget:self action:@selector(addshoppingcarButtonClick) forControlEvents:UIControlEventTouchUpInside];
    return _addshoppingcarButton;
}

-(void)addshoppingcarButtonClick{
if (self.didSelectedaddshoppingcarButton) {
    self.didSelectedaddshoppingcarButton(self.GeneralGoodsModel);
}
}
...
-(void)layoutSubviews{
    ...
    self.addshoppingcarButton.sd_layout
