...
#import "TheAnnouncementModel.h"

#import "TheAnnouncementTableViewCell.h"

#import "TheAnnouncementDetailsViewController.h"

@interface TheAnnouncementViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TheAnnouncementViewController{
    ...
    [HttpRequest postWithURLString:NetRequestUrl(usernotice) parameters:dic
                  ...
                  isShowBlankPages:(BOOL)NO
                           success:^(id responseObject)  {
                               ...
                               NSArray *result = [TheAnnouncementModel mj_objectArrayWithKeyValuesArray:responseObject[@"result"]];
                               [self hideEmptyView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //通过cell的类方法直接初始化cell
    TheAnnouncementTableViewCell *cell = [TheAnnouncementTableViewCell mainTableViewCellWithTableView:tableView];
    
    //根据相应的cell的行数进行每行cell的数据设置
    kArrayIsEmpty(self.dataSource)?:[cell setTheAnnouncementModel:self.dataSource[indexPath.section]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TheAnnouncementModel *model=self.dataSource[indexPath.section];
    tadvc.TheAnnouncementDetailsid=model.article_id;
