...
//        self.increaseButton.enabled = YES;
        ...
        self.decreaseButton.selected = YES;
...
//        self.increaseButton.enabled = NO;
        self.decreaseButton.selected = NO;
...
- (UIButton *)decreaseButton {
    if(_decreaseButton == nil) {
        ...
        [_decreaseButton setBackgroundImage:[UIImage imageNamed:@"product_detail_sub_no"] forState:UIControlStateSelected];
...
- (UIButton *)increaseButton
{
    if(_increaseButton == nil)
    {
        ...
        [_increaseButton setBackgroundImage:[UIImage imageNamed:@"product_detail_add_no"] forState:UIControlStateSelected];
