...
- (void)configureShopcartBottomViewWithTotalPrice:(float)totalPrice totalCount:(NSInteger)totalCount isAllselected:(BOOL)isAllSelected {
    ...
    [self.settleButton setTitle:[NSString stringWithFormat:@"去结算(%ld)", (long)totalCount] forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    if (_deleteButton == nil){
        ...
        [_deleteButton setTitle:@"快速删除" forState:UIControlStateNormal];
