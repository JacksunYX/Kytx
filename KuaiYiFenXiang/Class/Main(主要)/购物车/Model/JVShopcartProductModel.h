...
@property (nonatomic, assign) CGFloat productPrice;       //价格
...
@property (nonatomic, copy) NSString *activitysmallimageurlString;   //活动图片url

@property (nonatomic, copy) NSString *activitysmalltextString;   //活动内容
