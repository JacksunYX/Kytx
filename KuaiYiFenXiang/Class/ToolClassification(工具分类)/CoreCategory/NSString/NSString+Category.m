...
@implementation NSString_Category
...
{
    NSString *string;
    string = [string1 stringByReplacingCharactersInRange:NSMakeRange(3, 4) withString:@"****"];
...
{
    CGRect rect = [self boundingRectWithSize:CGSizeMake(wide, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:font]} context:nil];
    return rect;
...
{
    CGRect rect = [self boundingRectWithSize:CGSizeMake(MAXFLOAT, high) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:font]} context:nil];
    return rect;
}
